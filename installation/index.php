...
#D4J_User3,#D4J_User4{width:<?php echo (100 - 4*($centerusers-1))/$centerusers."%";?>}
<?php }?>
<?php if($bottomusers > 0) {?>
#D4J_User5,#D4J_User6,#D4J_User8,#D4J_User9{width:<?php echo (100 - 4*($bottomusers-1))/$bottomusers."%";?>}
<?php }?>
</style>
<!--[if IE ]>
<style type="text/css">
#D4J_MainPage{margin-top:0}
#D4J_RightSide .moduletable-box{height:123px;padding:60px 36px 40px 36px}
#D4J_RightSide .moduletable-box h3{margin-bottom:30px}
</style>
<![endif]-->
<!--[if lt IE 7.]>
<style type="text/css">
...
#D4J_MainPage{margin-top:-60px}
#D4J_Title{margin:118px 0 0 30px;width:400px}
#D4J_LeftSide{margin:50px 0 0 30px}
#D4J_RightSide{margin-left:11px}
#D4J_User2,#D4J_User4{margin-left:2.5%}
<![endif]-->
<style type="text/css">
<?php if(!$right_side){?>
	#D4J_LeftSide{width:850px}
	#D4J_MainPage_In{background:url(<?php echo _TEMPLATE_URL;?>/images/img18.jpg) top left no-repeat}
	#D4J_MainPage_In2{background:url(<?php echo _TEMPLATE_URL;?>/images/img16.jpg) top right no-repeat}
	#D4J_MainPage_In4{background:url(<?php echo _TEMPLATE_URL;?>/images/img15.jpg) bottom right no-repeat}
	#D4J_MainPage{background:#FFF url(<?php echo _TEMPLATE_URL;?>/images/img17.jpg) repeat-y}
	#D4J_Top .moduletable,#D4J_Banner .moduletable,#D4J_Bottom .moduletable{background:url(<?php echo _TEMPLATE_URL;?>/images/img19.jpg) left 45px no-repeat}
<?php }?>
</style>
<!--[if lt IE 7.]>
<style type="text/css">
...
<div id="D4J_Container">
	<div id="D4J_TopPage">
		<div id="D4J_Title">
				<?php if(mosCountModules('header')) mosLoadModules('header',-2); else echo '<h1 title="'.$GLOBALS['mosConfig_sitename'].'"><a href="'.$GLOBALS['mosConfig_live_site'].'" title="'.$GLOBALS['mosConfig_sitename'].'">hyperglass</a></h1> joomla template by <a href="http://designforjoomla.com">designforjoomla</a>';?>
		</div>
		<div id="D4J_MainMenu">
	...
	<div id="D4J_MainPage_In2">
	<div id="D4J_MainPage_In3">
	<div id="D4J_MainPage_In4">
		<div id="D4J_LeftSide">
