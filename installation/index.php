...
$images        = array('img01.jpg','img02.jpg','img03.jpg','img04.jpg','img05.jpg'); // name of the images
$time          = 10;                // time delay (s)
...
<?php } elseif (mosCountModules('user2')) { ?>
          ...
          #user2{width:100%}
<?php } else { ?>
          #user1,#user2{width:0px;height:0}
<?php } ?>
...
<?php if ($topModules > 0) { ?>
<?php } if ($topModules == 3) { ?>
        #user5,#user6,#user7{width:33%}
<?php } elseif ($topModules == 2) { ?>
        #user5,#user6,#user7{width:50%}
<?php } elseif ($topModules == 1) { ?>
        #user5,#user6,#user7{width:100%}
<?php } ?>
<?php if (mosCountModules ('left') OR mosCountModules ('right') OR mosCountModules ('user8') OR mosCountModules ('user9')) { ?>
          #lbox{width:220px}
          #rbox{width:454px}
          #mainbody{width:424px}
<?php } else { ?>
          #rbox,#top,#box1,#banner,#box2,#bottom{width:704px}
          #rbox .moduletable,#mainbody{margin:0;padding:0 15px 0 15px}
...
<?php if (mosCountModules ('left') OR mosCountModules ('right') OR mosCountModules ('user8') OR mosCountModules ('user9')) { ?>
          #mainbody{width:454px}
<?php } else { ?>
          #mainbody{width:704px}
<?php } ?>
</style>
<![endif]-->
...
<div id="container">
        <div id="header">
              ...
              <div id="advert1"><?php if (mosCountModules('advert1')) mosLoadModules('advert1', -1);
                    else echo '<img src="'._TEMPLATE_URL.'/images/img01.jpg" width="704" height="160" alt="" />';?></div>
              <div id="spacer"><!-- --></div>
        </div>
