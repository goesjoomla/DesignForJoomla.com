...
<?php } else { ?>
          #rbox{width:634px}
          #top,#bottom{margin:0;width:594px}
          #mainbody{margin:0;width:554px;background:url('<?php echo _TEMPLATE_URL ?>/images/bottompost1.gif') bottom left no-repeat}
          #lbox,#lbox_bottom{width:0px;height:0px}
          body{background:#4d4d4d url('<?php echo _TEMPLATE_URL ?>/images/bg1.gif') top center repeat-y}
          #header{background:url('<?php echo _TEMPLATE_URL ?>/images/header1.gif') top left no-repeat}
          #top .moduletable,#bottom .moduletable{background:url('<?php echo _TEMPLATE_URL ?>/images/bottompost1.gif') bottom left no-repeat}
<?php } ?>
</style>
<!--[if lt IE 7]>
...
<?php if (mosCountModules ('left') OR mosCountModules ('right')) { ?>
<?php } else { ?>
          #mainbody{width:594px}
          #rbox,{margin:0 0 0 10px}          
<?php } ?>
</style>
...
<div id="container">
         <div id="header">
                ...
                <div id="slogan"><?php if (mosCountModules('user7')) mosLoadModules('user7', -1);
                                   else echo '<h1>PattyMcFatPat01</h1> ' ?></div>
                </div>
                <div id="button">
