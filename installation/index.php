...
$topModules = (mosCountModules('user5') ? 1 : 0) + (mosCountModules('user6') ? 1 : 0) + (mosCountModules('user7') ? 1 : 0) + (mosCountModules('user8') ? 1 : 0) + (mosCountModules('user9') ? 1 : 0);
...
<?php if ($topModules > 0) { ?>
<?php } if ($topModules == 5) { ?>
        #user5,#user6,#user7,#user8,#user9{width:19.9%}
<?php } elseif ($topModules == 4) { ?>
        #user5,#user6,#user7,#user8,#user9{width:24.9%}
<?php } elseif ($topModules == 3) { ?>
        #user5,#user6,#user7,#user8,#user9{width:33.3%}
<?php } elseif ($topModules == 2) { ?>
        #user5,#user6,#user7,#user8,#user9{width:49.9%}
<?php } elseif ($topModules == 1) { ?>
        #user5,#user6,#user7,#user8,#user9{width:100%}
...
<?php if (mosCountModules('left') OR mosCountModules('right') OR mosCountModules('newsflash')) { ?>
        #lbox{width:28.3%}
        #rbox{width:70%}
        #mainbody{width:97.5%;padding-left:10px}
<?php } else { ?>
        #lbox{width:0%;height:0}
        #rbox{width:98.3%}
        #mainbody{width:97.5%;padding-left:0}
...
<div id="container">
        <div id="header">
                <div id="advert1"><?php if (mosCountModules('advert1')) mosLoadModules('advert1', -1);
                        else echo '<h1>canvass</h1>' ?>
                </div>
                <div id="advert2"><?php if (mosCountModules('advert2')) mosLoadModules('advert2', -1);
                        else echo '<h1>by Free Css Templates</h1>' ?>
                </div>
        </div>
        <div id="content">
                <div id="lbox">
