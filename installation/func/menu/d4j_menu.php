...
if (!defined('_D4J_MENU_FUNC_INCLUDED')) {
        ...
        */
        function d4jGetMenuLink( $mitem, $level=0, &$params, &$menu_trans, $open=null ) {
                ...
                if ($showTips) {
                        $txt = preg_replace("/class=\"$menuclass\"/i", "onmouseover=\"showTips(this)\" onmouseout=\"clearTips()\" class=\"$menuclass\"", $txt);
                }
        ...
        */
        function d4jShowMenu( &$params, &$menu_trans ) {
                ...
                if ($params->get( 'expand_menu' )) {
                        ...
                        d4jRecurseMenu( 0, 0, $children, $open, $params, $menu_trans );
        ...
        */
        function d4jRecurseMenu( $id, $level, &$children, &$open, &$params, &$menu_trans ) {
                if (@$children[$id]) { // has child?
                        ...
                        foreach ($children[$id] as $row) { // list all childs
                                ...
                                d4jRecurseMenu( $row->id, $level+1, $children, $open, $params, &$menu_trans );
