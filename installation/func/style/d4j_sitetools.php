...
function writeTools(){
        ...
        <?php };if($site_tools_width){?>
                <a href="javascript:void(0);" onclick="changeContainerWidth(700);return false;">
                ...
                <a href="javascript:void(0);" onclick="changeContainerWidth(0);return false;">
                        <img src="<?php echo _TEMPLATE_URL; ?>/images/site_tools/autofit.gif" title="Auto fit in browser window" onclick="changeContainerWidth(0);" alt=""/>
                </a>
