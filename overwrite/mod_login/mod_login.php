...
// ie HTML when not logged in and trying to login
	...
	?>
			...
			<label for="mod_login_remember" id="mod_login_remember_label">
				<?php echo _REMEMBER_ME; ?>
			</label>
			<br />
			<input type="submit" name="Submit" class="button" value="<?php echo _BUTTON_LOGIN; ?>" />
			<br/>
			<a id="mod_lost_password" href="<?php echo sefRelToAbs( 'index.php?option=com_registration&amp;task=lostPassword' ); ?>">
	...
	if ( $registration_enabled ) {
		?>
<ul>
<li class="nonregister"><?php echo _NO_ACCOUNT; ?></li>
<li class="register"><a href="<?php echo sefRelToAbs( 'index.php?option=com_registration&amp;task=register' ); ?>">
					<?php echo _CREATE_ACCOUNT; ?></a></li>
